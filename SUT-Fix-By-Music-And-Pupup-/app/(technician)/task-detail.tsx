...
export default function TaskDetailScreen() {
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            // 📸 1. อัปโหลดรูปภาพทั้งหมดเข้า Firebase Storage (ได้ URL กลับมา)
            ...
            // 🚀 2. อัปเดตสถานะงานผ่าน API (PUT Request) [คะแนน Data Update]
            const updatePayload = {
                status: "รอตรวจสอบ",
            ...
            // 🚀 3. ส่งการแจ้งเตือนหานักศึกษาผ่าน API (POST Request) [คะแนน Data Create]
            if (job?.userId) {
            ...
            Alert.alert("ผิดพลาด", "ไม่สามารถเชื่อมต่อ API ได้ (เช็ค IP คอมพิวเตอร์)");
